...
var translations = {
  en: {
    ...
    claims_over_by: '+{n} over limit',
    claims_over_banner_title: 'You are {n} claim(s) over the limit',
    claims_over_banner_desc: 'Extra claims will still be submitted but flagged for admin review.',
  ...
  hi: {
    ...
    claims_over_by: '+{n} लिमिट से ज़्यादा',
    claims_over_banner_title: 'आप {n} क्लेम लिमिट से ज़्यादा हैं',
    claims_over_banner_desc: 'ज़्यादा क्लेम भी सबमिट होंगे लेकिन एडमिन रिव्यू के लिए मार्क किए जाएंगे।',
